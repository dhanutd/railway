...
class Statusbuggy extends StatefulWidget {
  const Statusbuggy({super.key});

  @override
  State<Statusbuggy> createState() => _StatusbuggyState();
}

class _StatusbuggyState extends State<Statusbuggy> {
    ...
    try {
      if (dataKey != null) {
        ...
        FirebaseDatabase.instance
            .ref("buggy_booking").child(dataKey).update({
          'status': "Completed",
        });
  ...
  void delete(String ? datakey) {
    try {
      if (datakey != null) {
        FirebaseDatabase.instance
            .ref("buggy_booking").child(datakey).remove();
